...
The function `get_earthquake_data` allows you to load a snapshot of the earthquake's data downloaded on September 05, 2017; on the proviso that you want to get the latest data from the NOAA's Website, you can use `download_earthquake_data` function (requires internet access).
