...
Please check the [package's vignette](./vignettes/using-rnoaa.Rmd) to see further examples or review the examples given in the package's documentation (use `?function_name`).
